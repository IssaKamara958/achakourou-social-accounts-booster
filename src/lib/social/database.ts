...
export class SocialAccountsService {
   ...
   */
  static async updateToken(accountId: string, accessToken: string, refreshToken?: string, expiresAt?: string) {
...
export class SocialAnalyticsService {
   ...
   */
  static async recordAnalytics(analyticsData: Omit<SocialAnalytics, 'id' | 'created_at' | 'updated_at'>) {
    const { data, error } = await supabase
