...
import { Globe, Sparkles, Copy, ExternalLink, Plus, CheckCircle2, FileText, Search } from "lucide-react";
      ...
      <motion.div variants={fadeUp}>
        <Card className="p-6 bg-card border-border space-y-4">
          ...
          <div className="flex gap-3">
            ...
            >
              {generating ? "Génération…" : "Générer page SEO"}
            </Button>
          </div>
              ...
              <form onSubmit={addManual} className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input value={newPage.title} onChange={(e) => setNewPage({ ...newPage, title: e.target.value })} required />
                  </div>
                  <div className="space-y-2">
                    <Label>Slug URL</Label>
                    <Input value={newPage.slug} onChange={(e) => setNewPage({ ...newPage, slug: e.target.value })} placeholder="mon-article-seo" required />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label>Meta description</Label>
                  <Textarea rows={2} value={newPage.metaDescription} onChange={(e) => setNewPage({ ...newPage, metaDescription: e.target.value })} className="resize-none" />
                </div>
                <div className="space-y-2">
                  <Label>Contenu</Label>
                  <Textarea rows={4} value={newPage.content} onChange={(e) => setNewPage({ ...newPage, content: e.target.value })} className="resize-none" />
                </div>
                <div className="flex gap-3">
