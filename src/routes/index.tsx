    ...
    >
      <header className="max-w-6xl mx-auto px-6 py-6 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <div className="h-9 w-9 rounded-lg flex items-center justify-center font-black text-primary-foreground shadow-lg shadow-primary/20 transition-transform hover:scale-105" style={{ background: "var(--gradient-brand)" }}>
            <Sparkles className="h-5 w-5 fill-current" />
          </div>
          <div>
            <div className="text-sm font-bold">Achakourou TikTok AI</div>
            <div className="text-[10px] text-muted-foreground uppercase tracking-[0.2em] font-medium opacity-80">Agency SaaS</div>
          </div>
        </Link>
        <div className="flex items-center gap-2">
          ...
          <Button className="font-bold transition-all hover:scale-105 active:scale-95 shadow-sm" style={{ background: "var(--gradient-brand)", color: "var(--primary-foreground)" }} asChild>
      ...
      <main>
        <section className="max-w-5xl mx-auto px-6 pt-20 pb-24 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-border bg-card/50 text-xs font-medium text-muted-foreground mb-8 backdrop-blur-sm">
            <Zap className="h-3.5 w-3.5 text-primary fill-primary/20" /> AI-powered viral engine for TikTok agencies
          </div>
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[1.1] text-balance">
            Generate <span className="bg-clip-text text-transparent" style={{ backgroundImage: "var(--gradient-brand)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", display: "inline-block" }}>viral TikTok</span><br />scripts in seconds.
          </h1>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Button size="lg" className="h-14 px-8 text-base font-bold transition-all hover:scale-105 active:scale-95" style={{ background: "var(--gradient-brand)", color: "var(--primary-foreground)", boxShadow: "var(--shadow-glow)" }} asChild>
              <Link to="/login">
